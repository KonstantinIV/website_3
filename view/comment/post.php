<div class="main_cont">
 ...
 <div class="post_header"> <?php echo $this->data['postData']['title'] ?></div> 
                                                <div class="post_user"><?php echo $this->data['postData']['username'] ?></div> 
                                                <div class="column_2">
                                                        <div class="text_cont">
                                                                <p class="post_text"><?php echo $this->data['postData']['text'] ?></p>
                                                ...
                                                <div class="post_buttons">
                                                        ...
                                                        <div class="di_li_cont">
                                                                <div class="likes"><?php echo $this->data['postData']['likes'] ?></div>
                                                                <div class="">&#9679</div>
                                                                <div class="dislikes"><?php echo $this->data['postData']['dislikes'] ?></div>
                                                        </div>        
