...
class UserProfileFollowButton extends React.Component {
  ...
  getFollowerData(username){
    ...
    ajaxApi("/follower","GET",params, result => {
      if(result.flag){
        this.setState({
          following : true
        })
      ...
      followUser(username){
        let params = {username : username};
        ajaxApi("/follower","POST",params, result => {
          if(result.flag){
            this.setState({
              unfollowHover : true,
              following : true
      ...
      unfollowUser(username){
        let params = {username : username};
        ajaxApi("/follower","DELETE",params, result => {
          if(result.flag){
            this.setState({
              following : false,
              unfollowHover : false,
...
class UserPosts extends React.Component {
  ...
  createPost(thread,title,text,day,month,year){
    ...
    ajaxApi("/indexPage","POST",params, result => {
     if(result.flag){
      this.setState(prevstate => {
...
class UserThreads extends React.Component {
  ...
  createThread(threadTitle,threadDescription){
   ...
   ajaxApi("/thread","POST",params, result => {
     if(result.flag){
      this.setState(prevstate => {
